...
Welcome to the third module of the Java Foundation series. Here, we transition from basic object-oriented concepts into the advanced features that make up professional, enterprise-grade Java code.

If you ever plan to use frameworks like Spring Boot or Hibernate, mastering **Generics** and **Annotations** is absolutely non-negotiable.
...
3. **[Generics](explanation/03-generics.md)**
   - Writing flexible, type-safe code and understanding the bizarre reality of Type Erasure.
...
6. **[The Object Class](explanation/06-object-class.md)**
...
```shell
./gradlew :00-java-foundation:run --args="EnumDemo"
```
